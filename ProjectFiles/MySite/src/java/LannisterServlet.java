 ...
 * @author x12358831
 */
@WebServlet(urlPatterns = {"/LannisterServlet"})
public class LannisterServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String XMLFileName = path + "/fireandice.xml";
            String XSLFileName = path + "/LannisterStyle.xsl";
